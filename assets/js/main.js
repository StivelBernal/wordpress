(function($){ 
  ...
  function primer_destino() {
    ...
    var destino = $('#default_destino');
   
    /**Aqui toca pegarle a wordpress y traer las entradas correspondiente a estos users Ids*/
    $('#results-home-extracto').html(destino.attr('excerpt'));
    $('#results-home-departamento').html(destino.attr('departamento'));
    $('#results-home-municipio').html(destino.attr('municipio'));
    ...
    var form        =   {
        action:         'serlib_entries',
        alcaldia:       destino.attr('alcaldia'),
        gobernacion:    destino.attr('gobernacion')
    };
