    ...
    $formHTML  = str_replace(
      ['register_has_I18N', 'turista_rol_I18N', 'required_I18N', 'email_error_I18N', 'password1_I18N',
       ...
       'Tipo_documento_I18N', 'Numero_documento_I18N', 'Fotocopia_documento_I18N', 'Usuario_creado_I18N', 'register_comerciante_I18N',
        'register_turista_I18N', 'Ubicacion_negocios_I18N', 'terms_and_polities_text_I18N', 'more_terms_I18N', 'more_terms_text_I18N',
         'accept_terms_and_polities_I18N', 'term_and_polities_html' ], 
       [ 
         ...
         __('texto politicas', 'serlib'),  __('da click aqui', 'serlib'),  __('para saber más', 'serlib'),  __('acepto terminos y politicas', 'serlib'), $term_and_polities_html     
       ],
      $formHTML
    );
