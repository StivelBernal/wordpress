...
function serlib_plugin_cities_page()
{

?>
<div class="wrap" ng-app="serApp" ng-controller="cityController" ng-cloak>
    
    <h1 class="wp-heading-inline">
        <?php echo __('Municipios', 'serlib'); ?> </h1>
    ...
    <form class="search-form search-plugins"  style="margin-top:-30px;">
        <p class="search-box">
            <input type="search" class="wp-filter-search" ng-model="search" placeholder="<?php echo __('Buscar municipio...', 'serlib'); ?>">
        </p>
    </form> 
