...
function serlib_register_form_shortcode(){
    ...
    $formHTML  = str_replace(
      ['register_has_I18N', 'turista_rol_I18N', 'required_I18N', 'email_error_I18N', 'password1_I18N',
       ...
       'Tipo_documento_I18N', 'Numero_documento_I18N', 'Fotocopia_documento_I18N', 'Usuario_creado_I18N', 'register_comerciante_I18N', 'register_turista_I18N'], 
       [ 
         ...
         , __('Registro Comerciante', 'serlib'), __('Registro como turista', 'serlib')
       ],
      $formHTML
    );
  ...
  function longLiveToken( $token, $cs ) { 
    ...
    $data = json_decode(curl_exec($ch), true);
    curl_close($ch); 
    if( isset($data["acces_token"]) ){ return $data; }else { return NULL; }
