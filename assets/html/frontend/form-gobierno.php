...
<div class="row toolbar-actions p_tabs ">
    ...
    <div class="s-flex"><p md-truncate="" ng-class="{active_step: step >= 2, active_hover: step === 2}" ng-disabled="content.$invalid" ng-click="set_step(2, content.$invalid)"><i class="fa fa-users" title="'.$STEP2.'" aria-hidden="true"></i><span>'.$STEP2.'</span></p></div>
    <div class="s-flex"><p md-truncate="" ng-class="{active_step: step === 3, active_hover: step === 3}" ng-disabled="content.$invalid" ng-click="set_step(3, content.$invalid)"><i class="fa fa-map-marker" aria-hidden="true" title="'.$STEP3.'" ></i><span>'.$STEP3.'</span></p></div>
    <div class="s-7"></div>
